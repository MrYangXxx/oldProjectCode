	...
	<div class="data_content">
		...
		<table width="80%" align="center">
			...
			<tr>
				...
				<td colspan="4">
					<input type="text" id="cardNo" name="cardNo" value="${student.cardNo }" class="input-large"/> 
				</td>
			</tr>
			<tr>
				<td><label>专业：</label></td>
				<td><input type="text" id="prefession" name="prefession" value="${student.prefession }"/></td>
				<td></td>
				<td><label>密码：</label></td>
				<td><input type="text" id="password" name="password" value="${student.password }"/></td>
			</tr>
			<tr>
				<td>
