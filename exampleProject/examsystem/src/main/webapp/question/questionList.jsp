		...
		<form action="${pageContext.request.contextPath}/question!list" method="post">
			<table align="center">
				<tr>
					...
					<td><input type="text" id="s_subject" name="subject" value="${question.subject }"/></td>
					<td>&nbsp;</td>
	...
	<div class="data_content">
		<table class="table table-bordered table-hover">
			...
			<tr>
				...
				<td><button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='question!show?questionId=${question.id}'">查看试题</button>&nbsp;&nbsp;<button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='question!preSave?questionId=${question.id}'">修改</button>&nbsp;&nbsp;<button class="btn btn-mini btn-danger" type="button" onclick="deleteQuestion('${question.id}')">删除</button></td>
			</tr>
			</c:forEach>
		</table>
	</div>
