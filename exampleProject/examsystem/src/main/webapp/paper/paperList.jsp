	...
	<div class="data_content">
		<table class="table table-bordered table-hover">
			...
			<tr>
				...
				<td><button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='paper!preSave?paperId=${paper.id}'">修改</button>&nbsp;&nbsp;<button class="btn btn-mini btn-danger" type="button" onclick="deletePaper('${paper.id}')">删除</button></td>
			</tr>
			</c:forEach>
		</table>
	</div>
