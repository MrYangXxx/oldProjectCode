		...
		<form action="${pageContext.request.contextPath}/exam!list" method="post">
			<table align="center">
				<tr>
					...
					<td><input type="text" id="s_id" name="exam.student.id" value="${exam.student.id }"/></td>
					<td>&nbsp;</td>
					<td><label>姓名：</label></td>
					<td><input type="text" id="s_name" name="exam.student.name" value="${exam.student.name }"/></td>
					<td>&nbsp;</td>
