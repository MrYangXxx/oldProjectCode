...
if(strId==null||strId.trim().equals("")){
	...
	out.print("<a href='article.jsp'>返回标题列表</a>");
	return;
}
try{
...
rs=databaseConn.executeQuery(stmt, "select title from article where id="+id);
rs.next();
...
<link rel="alternate" type="application/rss+xml" title="RSS" href="reply.jsp?id=<%=a.getId() %>&rootId=<%=a.getRootId()%>">
</head>
<body>
...
<div id="jive-flatpage">
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr valign="top">
        <td width="99%"><p class="jive-breadcrumbs"> <a href="articleFlat.jsp">首页</a> &#187; <a href="article.jsp">ChinaJavaWorld技术论坛|Java世界_中文论坛</a> &#187; <a href="article.jsp">Java 2 Platform, Standard Edition (J2SE)</a> &#187; <a href="article.jsp">Java语言*初级版</a> </p>
  ...
  <div class="jive-buttons">
    <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          <td class="jive-icon">&nbsp;&nbsp;&nbsp;&nbsp;<a href="reply.jsp?id=<%=id%>&rootId=<%=a.getRootId()%>"><img src="images/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a></td>
          <td class="jive-icon-label"><a id="jive-reply-thread" href="reply.jsp?id=<%=id %>&rootId=<%=a.getRootId()%>">回复本主题</a> </td>
        </tr>
      </tbody>
    </table>
  </div>
                      ...
                      <tr id="jive-message-780144" class="jive-odd" valign="top">
                        ...
                        <td class="jive-last" width="99%"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                              <tr valign="top">
                                <td width="1%"></td>
                                <td width="97%"><span class="jive-subject"><%=floor+"------"+b.getTitle() %></span> </td>
                                ...
                                <td width="1%"><div class="jive-buttons">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td class="jive-icon"><a href="reply.jsp?id=<%=b.getId() %>&rootId=<%=b.getRootId()%>" title="回复本主题"><img src="images/reply-16x16.gif" alt="回复本主题" border="0" height="16" width="16"></a> </td>
                                          <td class="jive-icon-label"><a href="reply.jsp?id=<%=b.getId() %>&rootId=<%=b.getRootId()%>" title="回复本主题">回复</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div></td>
