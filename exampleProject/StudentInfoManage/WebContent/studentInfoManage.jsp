...
<script type="text/javascript">
	function searchStudent() {
		$('#dg').datagrid('load', {
			...
			gender : $("#s_gender").combobox("getValue"),
				...
				$.post("studentDelete", {
					...
					if (result.success) {
						...
						$.messager.alert("系统提示", "<font color=red>"
								+ selectedRows[result.errorIndex].studentName
...
<body style="margin: 5px">
	<table id="dg" title="学生信息" class="easyui-datagrid" fitColumns="true"
		...
		<thead>
			<tr>
				...
				<th field="gradeId" width="100" align="center" hidden="true">班级名称</th>
	...
	<div id="tb">
		...
		<div>
			...
			&nbsp;性别：
			<select class="easyui-combobox" name="s_gender" id="s_gender" size="10"
			...
			&nbsp;出生日期：
			<input class="easyui-datebox" name="s_bbirthday" id="s_bbirthday"
				size="10" editable="false" />
			<input class="easyui-datebox" name="s_ebirthday" id="s_ebirthday"
				size="10" editable="false" />
			&nbsp;所属班级：
			<input class="easyui-combobox" name="s_gradeId" id="s_gradeId"
				editable="false" size="10"
				data-options="valueField:'id',textField:'gradeName',url:'gradeComboList'" />
	...
	<div id="dlg" class="easyui-dialog"
		style="width: 580px; height: 280px; padding: 10px 20px;" closed="true"
		buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table>
				...
				<tr>
					<td>性别：</td>
					<td><select class="easyui-combobox" name="gender" id="gender" size="10"
				...
				editable="false" data-options="valueField:'id',textField:'gradeName',url:'gradeComboList'" /></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>email：</td>
				...
				<tr>
					...
					<td><textarea rows="7" cols="30" name="stuDesc" id="stuDesc"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
