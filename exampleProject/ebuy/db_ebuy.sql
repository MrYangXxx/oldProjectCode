CREATE DATABASE  IF NOT EXISTS `db_ebuy` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `db_ebuy`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: db_ebuy
-- ------------------------------------------------------
...
--
-- Dumping data for table `t_bigtype`
--

LOCK TABLES `t_bigtype` WRITE;
/*!40000 ALTER TABLE `t_bigtype` DISABLE KEYS */;
INSERT INTO `t_bigtype` VALUES (1,'服饰','服装'),(2,'数码',NULL),(3,'美食',NULL),(4,'家电',NULL);
...
INSERT INTO `t_news` VALUES (1,NULL,'2013-01-01 00:00:00','新闻一'),(2,NULL,'2013-01-01 00:00:00','新闻二'),(3,NULL,'2013-01-01 00:00:00','新闻三'),(4,NULL,'2013-01-01 00:00:00','新闻四'),(5,NULL,'2013-01-01 00:00:00','新闻五'),(6,NULL,'2013-01-01 00:00:00','新闻六'),(7,NULL,'2013-01-01 00:00:00','新闻七'),(8,NULL,'2013-01-01 00:00:00','新闻八'),(11,'<p>tset3</p>\r\n','2018-06-04 00:00:00','test3');
...
INSERT INTO `t_order` VALUES (1,3767,'2018-05-25 21:55:10','20180525095510',4,4),(2,405,'2018-06-04 00:04:30','20180604120429',3,7);
...
INSERT INTO `t_order_product` VALUES (1,1,1,25),(2,1,1,38),(3,1,2,294),(4,1,2,25),(5,1,2,87);
...
CREATE TABLE `t_product` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKljmruxg0enspttsfitdiwwvv3` (`bigTypeId`),
  KEY `FKjshxkcveus05j50e89e04bltu` (`smallTypeId`),
  CONSTRAINT `FKjshxkcveus05j50e89e04bltu` FOREIGN KEY (`smallTypeId`) REFERENCES `t_smalltype` (`id`),
  CONSTRAINT `FKljmruxg0enspttsfitdiwwvv3` FOREIGN KEY (`bigTypeId`) REFERENCES `t_bigtype` (`id`)
...
CREATE TABLE `t_smalltype` (
  ...
  `bigTypeId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKrkq3khqxbbs4x6ajojmfvs0qf` (`bigTypeId`),
  CONSTRAINT `FKrkq3khqxbbs4x6ajojmfvs0qf` FOREIGN KEY (`bigTypeId`) REFERENCES `t_bigtype` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `t_smalltype`
--

LOCK TABLES `t_smalltype` WRITE;
/*!40000 ALTER TABLE `t_smalltype` DISABLE KEYS */;
INSERT INTO `t_smalltype` VALUES (6,'连衣裙','1',1),(7,'男士西装',NULL,1),(8,'牛仔裤',NULL,1),(9,'相机',NULL,2),(29,'音箱',NULL,2),(30,'MP3/MP4',NULL,2),(31,'进口食品',NULL,3),(32,'地方特产',NULL,3),(33,'休闲食品',NULL,3),(34,'平板电视',NULL,4),(35,'洗衣机',NULL,4),(36,'冰箱',NULL,4);
...
INSERT INTO `t_tag` VALUES (1,'音乐','http://www.java1234.com'),(2,'影视','http://www.baidu.com'),(3,'少儿','http://www.jimblog.site'),(4,'运动鞋','http://qq.com'),(5,'美容护肤',NULL),(6,'家纺用品',NULL),(7,'婴幼奶粉',NULL),(8,'饰品',NULL);
...
INSERT INTO `t_user` VALUES (1,'郑州22','2014-09-04 00:00:00','411522199407254576','admin@qq.com','13523902576','123456','女',2,'张三3','java1234'),(2,'江苏南京','1989-01-01 00:00:00','411522199407254572','123@qq.com','13523902572','123','女',1,'qwe','marry'),(4,'好地方4','2014-04-04 00:00:00','213214','1214@1234.com','3213213214','1234','男',1,'jack','jack'),(5,'2321','2014-09-14 00:00:00','411522199407254576','abc@qq.com','13523902576','123','男',1,'t','tom'),(6,'江苏南京六合','2014-08-31 00:00:00','411522199407254576','123@qq.com','13523902576','123','男',1,'王二小','jerry'),(7,'123','2018-05-02 00:00:00','123','123','123','12345','男',2,NULL,'jim'),(8,'123','2018-06-19 00:00:00','123','123@qq.com','123','123','男',1,'jim','jim');
...
-- Dump completed on 2018-06-05 19:47:32
