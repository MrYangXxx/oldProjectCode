...
CREATE TABLE `tb_local_auth` (
  ...
  CONSTRAINT `fk_local_profile` FOREIGN KEY (`user_id`) REFERENCES `tb_person` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `tb_local_auth` */

insert  into `tb_local_auth`(`local_auth_id`,`user_id`,`user_name`,`password`,`create_time`,`last_edit_time`) values (6,8,'xiangze','s05bse6q2qlb9qblls96s592y55y556s','2017-06-04 19:09:51','2017-06-04 19:09:51'),(7,9,'test','s05bse6q2qlb9qblls96s592y55y556s','2017-06-05 22:05:13','2017-06-05 22:05:13');
...
CREATE TABLE `tb_phone_auth` (
  ...
  CONSTRAINT `fk_phoneauth_profile` FOREIGN KEY (`user_id`) REFERENCES `tb_person` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
insert  into `tb_product`(`product_id`,`product_name`,`product_desc`,`img_addr`,`normal_price`,`promotion_price`,`priority`,`create_time`,`last_edit_time`,`enable_status`,`point`,`product_category_id`,`shop_id`) values (4,'美式咖啡','一丝醇香，流连忘返','/upload/images/item/shop/15/2017060523302118864.jpg','12','11',12,'2017-06-05 23:30:21','2017-06-05 23:49:34',1,3,NULL,15),(5,'转让八成新XX牌小车','诚心转让八成新XX牌小车，有意者请连续8866666','/upload/images/item/shop/15/2017060523485289817.jpg','100000','60000',100,'2017-06-05 23:48:52','2017-06-05 23:48:52',1,0,9,15),(6,'转让电瓶车一辆','转让电瓶车一辆，可当面看车，电话：1111222','/upload/images/item/shop/15/2017060608490188656.jpg','3000','1200',99,'2017-06-06 08:49:01','2017-06-06 08:50:57',1,0,9,15),(7,'转让半新旧男装摩托车一辆','转让半新旧男装摩托车一辆，当面验车，电话：3333666','/upload/images/item/shop/15/2017060608502085437.jpg','8000','3000',98,'2017-06-06 08:50:20','2017-06-06 08:51:19',1,0,9,15),(8,'大量二手书籍转让','大量二手书籍转让，电话详谈，或上门看书。联系电话：5556666   地址：东苑XX楼','/upload/images/item/shop/16/2017060608574074561.jpg','0','0',100,'2017-06-06 08:57:40','2017-06-06 08:57:40',1,0,10,16),(9,'<十万个为什么>','出手一本《十万个为什么》，8成新，想要的可以联系：9998886','/upload/images/item/shop/16/2017060609025850665.png','25','10',98,'2017-06-06 09:02:58','2017-06-06 09:02:58',1,0,10,16),(10,'珍珠奶茶','珍珠奶茶，弹性十足，香甜美味。','/upload/images/item/shop/20/2017060620114126875.jpg','10','8',100,'2017-06-06 20:11:41','2017-06-06 20:11:41',1,0,11,20),(11,'红豆奶茶','红豆和奶茶的完美结合，夏天不错的选择。','/upload/images/item/shop/20/2017060620363014331.jpg','10','8',99,'2017-06-06 20:36:30','2017-06-06 20:36:30',1,1,11,20),(12,'绿豆冰','清热解毒。','/upload/images/item/shop/20/2017060620384620536.jpg','8','7',98,'2017-06-06 20:38:46','2017-06-06 20:38:46',1,0,11,20),(13,'芒果冰沙','新鲜芒果制作。','/upload/images/item/shop/20/2017060620472125629.jpg','15','13',95,'2017-06-06 20:47:21','2017-06-06 20:47:21',1,2,11,20),(14,'鲜榨芒果汁','新鲜芒果新鲜榨，香甜可口，解暑降温。','/upload/images/item/shop/20/2017060620492297296.jpg','8','8',93,'2017-06-06 20:49:22','2017-06-06 20:49:22',1,0,11,20),(15,'鲜榨西瓜汁','每一杯都是鲜榨的，现榨现卖。','/upload/images/item/shop/20/2017060621052824735.jpg','8','8',90,'2017-06-06 21:05:28','2017-06-06 21:05:28',1,0,11,20),(16,'测试1','测试Desc1','test1','','',10,'2018-09-15 16:14:05','2018-09-19 00:02:16',1,NULL,9,15),(17,'测试2','测试Desc2','test2',NULL,NULL,0,'2018-09-15 16:14:05','2018-09-15 16:14:05',0,NULL,10,15),(18,'测试3','测试Desc3','test3',NULL,NULL,0,'2018-09-15 16:14:05','2018-09-15 16:14:05',1,NULL,11,16),(19,'test2','good','\\upload\\item\\shop\\19\\2018091823294345548.JPG','500','499',123,'2018-09-18 23:29:43','2018-09-19 00:01:51',1,NULL,17,15);
...
CREATE TABLE `tb_shop_auth_map` (
  ...
  CONSTRAINT `fk_shop_auth_map_employee` FOREIGN KEY (`employee_id`) REFERENCES `tb_person` (`user_id`),
...
CREATE TABLE `tb_user_award_map` (
  ...
  CONSTRAINT `fk_user_award_map_profile` FOREIGN KEY (`user_id`) REFERENCES `tb_person` (`user_id`),
...
CREATE TABLE `tb_user_product_map` (
  ...
  CONSTRAINT `fk_user_product_map_profile` FOREIGN KEY (`user_id`) REFERENCES `tb_person` (`user_id`),
...
CREATE TABLE `tb_user_shop_map` (
  ...
  CONSTRAINT `fk_user_shop_user` FOREIGN KEY (`user_id`) REFERENCES `tb_person` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_wechat_auth` (
  ...
  CONSTRAINT `fk_oauth_profile` FOREIGN KEY (`user_id`) REFERENCES `tb_person` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
