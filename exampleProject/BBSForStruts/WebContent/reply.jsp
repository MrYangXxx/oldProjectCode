			...
			<tbody>
				<tr valign="top">
					<td width="99%"><p class="jive-breadcrumbs">
							<a href="article">首页</a> &#187; <a href="article">ChinaJavaWorld技术论坛|Java世界_中文论坛</a> &#187; <a
								href="article">Java 2 Platform, Standard Edition (J2SE)</a> &#187; <a href="article">Java语言*初级版</a>
						</p>
						<p class="jive-page-title">
							主题:
							<s:property value="a.getTitle" />
						</p></td>
							...
							<div class="jive-message-list">
								<div class="jive-table">
									<div class="jive-messagebox">
										...
										<form action="replyDeal" method="post" onsubmit="return check()">
											<input type="hidden" name="pId" value="${id }">
											<input type="hidden" name="rootId" value="${rootId }">
											标题：
											<input id="testTitle" type="text" name="title" style="width: 250px;">
											<br> 内容：
											<textarea id="textareaCont" class="ckeditor" name="cont"></textarea>
											<br>
									...
									<tbody>
										<tr>
											...
											<td align="center" width="98%"><table border="0" cellpadding="0" cellspacing="0">
													<tbody>
														<tr>
															<td><a href="article"><img src="images/arrow-left-16x16.gif" alt="返回到主题列表"
